...
lazy_static! {
    ...
    pub static ref AUTO_AUCTION_AT:chrono::NaiveTime = chrono::NaiveTime::from_hms_opt(23, 34, 45).unwrap();
...
lazy_static! {
    ...
    pub static ref AUTO_AUCTION_AT:chrono::NaiveTime = chrono::NaiveTime::from_hms_opt(7,0,0).unwrap();
